...
export default function GalleryPage() {
  ...
  // main image first, then related images — repeated for each gallery group.
  ...
  return (
    <>
      ...
      <div className="w-full md:mx-auto md:py-16 2xl:px-32 xl:px-20 lg:px-10 p-5 relative">
        ...
        <h1 className="text-3xl font-medium text-shadow-black mb-1.5 text-center uppercase z-50 relative text-white">
          Gallery
        </h1>
      </div>
              ...
              <div key={gallery.gallery_id} className="group">
                ...
                <PhotoView src={gallery.image}>
                  <div className="relative w-full aspect-[16/9] rounded-lg overflow-hidden shadow cursor-pointer">
                    ...
                    {/*
                      Use a native <img> instead of next/image fill so that
                      react-photo-view can correctly read naturalWidth/naturalHeight
                      and animate the zoom transition.
                    */}
                ...
                {/* RELATED IMAGES (lightbox only — no visible thumbnail) */}
